...
public class Catalina {
    ...
    /**
     * 解析server.xml文件,创建Socket并向启动了的服务器发送SHUTDOWN命令
     * @param arguments
     */
    ...
    public void load() {
        ...
        try {
            //standardServer(extends LifecycleMBeanBase extends LifecycleBase)中的init()
            //其实最主要的就是执行standardServer中的initInternal()
            getServer().init();
        } catch (LifecycleException e) {
