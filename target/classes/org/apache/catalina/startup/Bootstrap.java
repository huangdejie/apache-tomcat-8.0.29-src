...
public final class Bootstrap {
    ...
    private ClassLoader createClassLoader(String name, ClassLoader parent)
        ...
        //commonLoader 中的 Value=${catalina.base}/lib,${catalina.base}/lib/*.jar,${catalina.home}/lib,${catalina.home}/lib/*.jar
        ...
        //Repository是ClassLoaderFactory中的静态内部类，表示某个位置的某种类型的文件
    ...
    public void init() throws Exception {
        ...
        //初始化类加载器(commonLoader,catalinaLoader,sharedLoader),其中commonLoader的父类加载器为null，其余两个的父类加载器是commonLoader
        initClassLoaders();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (command.equals("startd")) {
                ...
                //设置catalinaDaemon中的await为true
                daemon.setAwait(true);
                //调用catalina中load方法,主要是解析server.xml,初始化一个server实例对象
                daemon.load(args);
                //实际上调用的是catalina中的start方法
                daemon.start();
